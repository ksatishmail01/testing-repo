...
//getting the total value for 3 months rego
		String threeMonths;
		threeMonths = driver.findElement(By.xpath("//*[@id='aside']/div/div/div[2]/div[13]/div[2]/div[1]/div[1]/dl/dd[2]")).getText();
		System.out.println("3 months value-----------------> " + threeMonths);
		
		
		
		String  registrationFee;
		registrationFee = driver.findElement(By.xpath("//*[@id='aside']/div/div/div[2]/div[13]/div[2]/div[1]/div[2]/ul/li[1]/span")).getText();
		System.out.println("Registration Fee------------------->" + registrationFee);
		Thread.sleep(2000);
		
		String tacCharge;
		tacCharge = driver.findElement(By.xpath("//*[@id='aside']/div/div/div[2]/div[13]/div[2]/div[1]/div[2]/ul/li[2]/span")).getText();
		System.out.println("TAC Charge-------------->" + tacCharge);
		Thread.sleep(2000);
		
		String insuranceDuty;
		insuranceDuty = driver.findElement(By.xpath("//*[@id='aside']/div/div/div[2]/div[13]/div[2]/div[1]/div[2]/ul/li[3]/span")).getText();
		System.out.println("Insurance Duty------------->" + insuranceDuty);
		Thread.sleep(2000);
		
		
		String serviceDuty;
		serviceDuty = driver.findElement(By.xpath("//*[@id='aside']/div/div/div[2]/div[13]/div[2]/div[1]/div[2]/ul/li[4]/span")).getText();
		System.out.println("Service Duty------------>" + serviceDuty);
		Thread.sleep(2000);
		
		
		String total;
		total = driver.findElement(By.xpath("//*[@id='aside']/div/div/div[2]/div[13]/div[2]/div[1]/div[2]/ul/li[5]/span")).getText();
